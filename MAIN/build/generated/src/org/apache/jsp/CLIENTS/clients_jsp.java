...
public final class clients_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    Connection conexionClient = DriverManager.getConnection("jdbc:mysql://localhost:3306/REDES", "root", "");
    Statement c = conexionClient.createStatement();
    ResultSet clients = c.executeQuery("SELECT * FROM CLIENTE");
      ...
      out.write("          <a class=\"dropdown-item\" href=\"clients.jsp\">Clients</a>\n");
      ...
      out.write("          </a>\n");
      out.write("          <div class=\"dropdown-menu\" aria-labelledby=\"navbarDropdownMenuLink\">\n");
      out.write("          <a class=\"dropdown-item\" href=\"../FIND/findClient.jsp\">Clients</a>\n");
      out.write("          <a class=\"dropdown-item\" href=\"../FIND/findServer.jsp\">Servers</a>\n");
      out.write("          </div>\n");
      out.write("        </li>     \n");
      out.write("      </ul>\n");
      ...
      out.write("        \n");
      out.write("  <div class=\"clients\"><h1>CLIENTS</h1></div>\n");
      ...
      out.write("        ");
          ...
          while (clients.next()) {
            out.println("<tr>");
            out.println("<th scope='row'>" + clients.getString("CodCli") + "</th>");
            out.println("<td>" + clients.getString("NomCli") + "</td>");
            out.println("<td>" + clients.getString("CatCli") + "</td>");
            out.println("<td>" + clients.getString("SisCli") + "</td>");
            out.println("<td>" + clients.getString("NicCli") + "</td>");
            out.println("<td>" + clients.getString("MacCli") + "</td>");
      ...
      out.print(clients.getString("CodCli"));
      out.write("\"/>\n");
      ...
      out.write("      </td>\n");
      out.write("      <td>        \n");
      out.write("        <button type=\"button\" class=\"btn btn-primary-one\" data-toggle=\"modal\" data-target=\"#clientModal");
      out.print(i);
      out.write("\">\n");
      out.write("          <i class=\"fa fa-trash\" aria-hidden=\"true\"></i>\n");
      out.write("        </button>\n");
      out.write("        <div id=\"clientModal");
      out.print(i);
      ...
      out.write("                <p>This action will erase this client. You sure?</p>\n");
      out.write("              </div>\n");
      out.write("              <div class=\"modal-footer\">\n");
      out.write("                <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n");
      out.write("                <form method=\"get\" action=\"deleteClient.jsp\">\n");
      out.write("                  <input type=\"hidden\" name=\"code\" value=\"");
      out.print(clients.getString("CodCli"));
      out.write("\"/>\n");
   ...
   i++;
      ...
      out.write("     <button type=\"button\" class=\"btn btn-primary-two\" data-toggle=\"modal\" data-target=\"#goClient\">\n");
      out.write("       <i class=\"fas fa-plus\"></i>\n");
      out.write("     </button>\n");
      out.write("       <div class=\"modal fade\" id=\"goClient\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\n");
      out.write("         <div class=\"modal-dialog\">\n");
      out.write("           <div class=\"modal-content\">\n");
      out.write("             <div class=\"modal-header\">\n");
      ...
      out.write("             </div>\n");
      out.write("            <div class=\"modal-body\">\n");
      out.write("              <form role=\"form\" method=\"get\" action=\"addClient.jsp\">\n");
      ...
      out.write("                  <input type=\"text\" class=\"form-control\" id=\"categoryField\" name=\"category\" placeholder=\"Category\"/>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"form-group\">\n");
      out.write("                  <label for=\"OS\">OS</label>\n");
      out.write("                  <input type=\"text\" class=\"form-control\" id=\"OSField\" name=\"system\" placeholder=\"Operative System\"/>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"form-group\">\n");
      out.write("                  <label for=\"nic\">NIC</label>\n");
      out.write("                  <input type=\"text\" class=\"form-control\" id=\"nicField\" name=\"nic\" placeholder=\"NIC Address\"/>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"form-group\">\n");
      out.write("                  <label for=\"mac\">MAC</label>\n");
      out.write("                    <input type=\"text\" class=\"form-control\" id=\"macField\" name=\"mac\" placeholder=\"MAC Address\"/>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"modal-footer\">\n");
