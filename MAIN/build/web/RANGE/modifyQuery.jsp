    ...
    if (reference != null) {
      ...
      int code = Integer.parseInt(reference);
        ...
        try {
          ...
          String sql = "Update alcance set NomAlc=?,DesAlc=? where CodAlc =" + code;
    ...
    <div class="row content">
      <div class="col-sm-7 sidenav">
        <div class="jumbotron jumbotron-fluid">
          ...
          <p class="lead">The range has been successfully updated</p>
          </div>
        </div>
      <div class="btn-dark-wrapper">
        <a href="range.jsp"><button type="button" class="btn btn-danger">I wanna go back</button></a>
      </div>
      </div>
      <div class="col-sm-5">
  ...
  %>
    ...
    <div class="row content">
      <div class="col-sm-7 sidenav">
        ...
        <div class="btn-dark-wrapper">
          <a href="range.jsp"><button type="button" class="btn btn-danger" style="margin-top:-100px;">I wanna go back</button></a>
        </div>
      </div>
      <div class="col-sm-5">
        <div class="circle-wrapper">
