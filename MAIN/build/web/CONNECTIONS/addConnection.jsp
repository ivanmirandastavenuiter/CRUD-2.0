...
<html>
  ...
  <%
    ...
    if (clientCode != null && serverCode != null) {
      ...
      int codeRange = Integer.parseInt(range);
        ...
        try {
          ...
          s.execute("INSERT INTO ENLACE(CodCli,CodSer,ProEnl,DisEnl,MedEnl,AlcEnl) VALUES ("
          + codeClient
          + ", " + codeServer + ""
          + ", '" + protocol + "'"
          + ", '" + device + "'"
    ...
    <div class="row content">
      <div class="col-sm-7 sidenav">
        <div class="jumbotron jumbotron-fluid">
          ...
          <p class="lead">The connection has been successfully added</p>
          </div>
        </div>
  ...
  <%
          ...
          request.setAttribute("error", formatFail);
  %>
  ...
  <div class="container-fluid">
    <div class="row content">
      <div class="col-sm-7 sidenav">
        ...
        <div><p>You can get a hint here: <%out.println(formatFail);%></p></div>
        <div class="btn-dark-wrapper">
          <a href="connections.jsp"><button type="button" class="btn btn-danger" style="margin-top:-100px;">I wanna go back</button></a>
        </div>
      </div>
