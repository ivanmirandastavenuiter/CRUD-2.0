    ...
    if (clientCode != null && serverCode != null) {
      ...
      int codeServer = Integer.parseInt(serverCode);
        ...
        try {
          ...
          s.execute("DELETE FROM ENLACE WHERE CodCli = " + codeClient 
    ...
    <div class="row content">
      <div class="col-sm-7 sidenav">
        <div class="jumbotron jumbotron-fluid">
          ...
          <p class="lead">The connection has been successfully erased</p>
          </div>
        </div>
      <div class="btn-dark-wrapper">
        <a href="connections.jsp"><button type="button" class="btn btn-dark">I wanna go back</button></a>
      </div>
      </div>
      <div class="col-sm-5">
