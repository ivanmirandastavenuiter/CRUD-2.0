...
<html lang="en">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <a class="dropdown-item" href="clients.jsp">Clients</a>
  ...
  <div class="clients"><h1>CLIENTS</h1></div>
    <table class="table table-hover table-dark">
      ...
      <td>
        <form method="get" action="modifyForm.jsp">
          <input type="hidden"  name="code" value="<%=clients.getString("CodCli")%>"/>
      ...
      <td>        
        <button type="button" class="btn btn-primary-one" data-toggle="modal" data-target="#clientModal<%=i%>">
          <i class="fa fa-trash" aria-hidden="true"></i>
        </button>
        <div id="clientModal<%=i%>" class="modal fade" role="dialog">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>This action will erase this client. You sure?</p>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <form method="get" action="deleteClient.jsp">
                  <input type="hidden" name="code" value="<%=clients.getString("CodCli")%>"/>
 ...
 <h1 class="formulario">WANNA ADD SMTH? </h1>
   <div class="plus-button">
     <button type="button" class="btn btn-primary-two" data-toggle="modal" data-target="#goClient">
       <i class="fas fa-plus"></i>
     </button>
       <div class="modal fade" id="goClient" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
         <div class="modal-dialog">
           <div class="modal-content">
             <div class="modal-header">
            ...
            <div class="modal-body">
              <form role="form" method="get" action="addClient.jsp">
