    ...
    if (reference != null) {
      ...
      int code = Integer.parseInt(reference);
        ...
        try {
          ...
          String sql = "Update cliente set NomCli=?,CatCli=?,SisCli=?,NicCli=?,MacCli=? where CodCli = " + code;
    ...
    <div class="row content">
      <div class="col-sm-7 sidenav">
        <div class="jumbotron jumbotron-fluid">
          ...
          <p class="lead">The client has been successfully updated</p>
          </div>
        </div>
      <div class="btn-dark-wrapper">
        <a href="clients.jsp"type="button" class="btn btn-danger">I wanna go back</a>
      </div>
      </div> 
      <div class="col-sm-5">
        ...
        <div class="btn-danger-wrapper">
           <a href="../home.jsp" type="button" class="btn btn-danger">I want to get home</a>
        </div>
      </div>
    </div>
  </div>
  ...
  %>
    ...
    <div class="row content">
      <div class="col-sm-7 sidenav">
        ...
        <div><p>You can get a hint here: <%out.println(sql);%></p></div>
        <div class="btn-dark-wrapper">
          <button type="button" class="btn btn-danger" style="margin-top:-100px;">I wanna go back</button>
        </div>
      </div>
      <div class="col-sm-5">
        <div class="circle-wrapper">
        ...
        <div class="btn-danger-wrapper">
          <button type="button" class="btn btn-danger">I want to get home</button>
        </div>
      </div>
    </div>
  </div>
